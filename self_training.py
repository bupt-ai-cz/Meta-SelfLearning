...
from dataset import hierarchical_dataset, AlignCollate, Batch_Balanced_Dataset, SelfTrainingDataset, self_training_collate
...
def train(opt):
    ...
    while(True):
        ...
        if train_dataset.has_pseudo_label_dataset(): 
            meta_target_index = opt.source_num
...
if __name__ == '__main__':
    ...
    parser.add_argument('--pseudo_threshold', type=float, default=0.98, help='The threshold of using pseudo labels')
